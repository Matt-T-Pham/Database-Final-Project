...
package CS_5530_Uber.sql_classes;
...
//        System.out.println("executing "+sql);
    ...
    public static String getMostPopularCars(int count, Statement stmt) {
        ...
        try{
            ...
            while (rs.next())
            {
                ...
                output += "   VIN: "+rs.getString("vin")+" - Number of Rides: "+rs.getString("count")+"\n";
            }
            rs.close();
        }
        catch(Exception e)
    ...
    public static String getMostExpensiveCars(int count, Statement stmt) {
        ...
        try{
            ...
            while (rs.next())
            {
                output += "   VIN: "+rs.getString("vin")+" - Cost: "+rs.getString("cost")+"\n";
            }
            rs.close();
        }
        catch(Exception e)
    ...
    public static String FindCars(String keyword, Statement stmt) {
        ...
        try{
            ...
            while (rs.next())
            {
                output+="<b> Make: "+rs.getString("make")+"   Model: "+rs.getString("model")+"   Category: "+rs.getString("category")+"   Driver Login: "+rs.getString("login")+"   VIN: "+rs.getString("vin")+"<BR>\n";
            }
