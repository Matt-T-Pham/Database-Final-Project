...
public class Connector
{
    ...
    public Connector() throws Exception
    {
        ...
        String sshUser = "5530u72";
        String sshPassword = "rrfnljgc";
       ...
       //String url = "jdbc:mysql://georgia.eng.utah.edu/cs5530db";// + lport + "/5530db72?allowMultiQueries=true";
        String url = "jdbc:mysql://localhost:" + lport + "/5530db72?allowMultiQueries=true";
        String dbUser = "5530u72";
        String dbPassword = "rrfnljgc";
