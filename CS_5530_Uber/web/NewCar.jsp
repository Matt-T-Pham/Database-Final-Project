...
<head>
    <script LANGUAGE="javascript">
        ...
        function check_all_fields(form_obj){
            alert(form_obj.vin.value +" | "+ form_obj.category.value +" | "+ form_obj.make.value +" | "+ form_obj.address.value )
            if( form_obj.vin.value == "" || form_obj.category.value == "" || form_obj.make.value == "" || form_obj.model.value == "" || form_obj.login.value == ""){
...
<%
    ...
    if(x!=null && x.equals("register"))
    {
        ...
        try {
            ...
            UberCar.newUberCar(tid,vin, category, make, model, login, con.stmt);
            %>
                <script LANGUAGE="javascript">
                    alert("Created new car");
                </script>
            <%
